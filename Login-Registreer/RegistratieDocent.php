...
<head>
    ...
    <title>Docent Registreren</title>
...
<nav> <!-- Navigatie 1 (trello) Gaby--> 
    ...
    <h1> Registratie formulier voor Docenten </h1> 
    <p div class="midden">Vul de formulier hieronder in om te registeren als Docent </p>
      <div class="midden"> 
    <form class="formulier" action="../Database/RegistratieDocent.php" method="post"> 
    ...
    <script>
        function validateForm() {
            ...
            var emailVolgorde = /^[a-zA-Z0-9._%+-]+@(?:tcrmbo\.nl)$/;
            if (!emailVolgorde.test(emailInput)) {
                alert("Registratie alleen mogelijk met een geldige docentenmail!.");
            }};
